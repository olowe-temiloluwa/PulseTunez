          ...
          >
            ...
            <div class="p-3 md:p-4">
              ...
              <div class="flex items-center justify-between">
                <span class="text-base md:text-lg font-bold text-blue-600 dark:text-blue-400">${{ relatedProduct.price }}</span>
                <button 
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            ...
            <div class="p-3 md:p-4">
              ...
              <div class="flex items-center justify-between">
                <span class="text-base md:text-lg font-bold text-blue-600 dark:text-blue-400">${{ recentProduct.price }}</span>
                <button 
