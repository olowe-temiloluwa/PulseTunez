  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600">We're here to help with all your audio and music equipment needs</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
            ...
            <div class="space-y-6">
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">08022738004</p>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">info@pulsetunez.com</p>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  <h3 class="font-semibold mb-1">Showroom</h3>
                  <p class="text-gray-600">123 Music Street, Audio District</p>
          ...
          <div class="bg-white rounded-lg shadow-sm p-8">
            ...
            <p class="text-gray-600 mb-4">Stay updated with our latest products and promotions</p>
